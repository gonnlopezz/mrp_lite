...
-- =========================================================================
-- 9. PRUEBA DE RENDIMIENTO Y VELOCIDAD (BENCHMARK)
-- CONFIGURACIÓN: 50 pedidos con 50 unidades cada uno (2500 unidades en total)
-- Distribución: 23 pedidos al 24/07, 4 pedidos al 25/07, 23 distribuidos
-- =========================================================================

-- =========================================================================
-- GRUPO A: 23 PEDIDOS CONCENTRADOS APUNTANDO AL 24 DE JULIO (CANTIDAD = 50)
-- =========================================================================
INSERT INTO pedido (fecha_pedido, fecha_entrega, cantidad, estado_pedido, cliente_id, producto_id) VALUES
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 500, 6),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 501, 6),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 502, 6),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 504, 6),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 500, 6),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 503, 1),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 504, 1),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 500, 2),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 501, 2),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 501, 3),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 502, 4),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 503, 3),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 504, 4),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 500, 3),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 502, 4),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 502, 7),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 503, 7),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 504, 7),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 500, 7),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 501, 7),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 502, 7),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 503, 7),
('2026-07-22', '2026-07-24', 50, 'PENDIENTE', 504, 7);

-- =========================================================================
-- GRUPO B: 4 PEDIDOS APUNTANDO AL 25 DE JULIO (CANTIDAD = 50)
-- =========================================================================
INSERT INTO pedido (fecha_pedido, fecha_entrega, cantidad, estado_pedido, cliente_id, producto_id) VALUES
('2026-07-23', '2026-07-25', 50, 'PENDIENTE', 500, 8),
('2026-07-23', '2026-07-25', 50, 'PENDIENTE', 501, 9),
('2026-07-23', '2026-07-25', 50, 'PENDIENTE', 502, 10),
('2026-07-23', '2026-07-25', 50, 'PENDIENTE', 503, 6);

-- =========================================================================
-- GRUPO C: 23 PEDIDOS RESTANTES PARA EL FLUJO COMPLETO (CANTIDAD = 50)
-- =========================================================================
INSERT INTO pedido (fecha_pedido, fecha_entrega, cantidad, estado_pedido, cliente_id, producto_id) VALUES
('2026-07-20', '2026-07-22', 50, 'PENDIENTE', 500, 1),
('2026-07-20', '2026-07-22', 50, 'PENDIENTE', 501, 2),
('2026-07-20', '2026-07-22', 50, 'PENDIENTE', 502, 3),
('2026-07-20', '2026-07-22', 50, 'PENDIENTE', 503, 4),
('2026-07-21', '2026-07-23', 50, 'PENDIENTE', 504, 6),
('2026-07-21', '2026-07-23', 50, 'PENDIENTE', 501, 8),
('2026-07-21', '2026-07-23', 50, 'PENDIENTE', 502, 9),
('2026-07-21', '2026-07-23', 50, 'PENDIENTE', 503, 10),
('2026-07-21', '2026-07-23', 50, 'PENDIENTE', 504, 8),
('2026-07-23', '2026-07-26', 50, 'PENDIENTE', 500, 1),
('2026-07-23', '2026-07-26', 50, 'PENDIENTE', 501, 2),
('2026-07-23', '2026-07-26', 50, 'PENDIENTE', 502, 3),
('2026-07-23', '2026-07-26', 50, 'PENDIENTE', 503, 4),
('2026-07-23', '2026-07-26', 50, 'PENDIENTE', 504, 6),
('2026-07-24', '2026-07-27', 50, 'PENDIENTE', 500, 8),
('2026-07-24', '2026-07-27', 50, 'PENDIENTE', 501, 9),
('2026-07-24', '2026-07-27', 50, 'PENDIENTE', 502, 10),
('2026-07-24', '2026-07-27', 50, 'PENDIENTE', 503, 6),
('2026-07-24', '2026-07-27', 50, 'PENDIENTE', 504, 8),
-- Mantenemos los últimos 4 con Producto 5 para validar el manejo rápido de excepciones
('2026-07-20', '2026-07-23', 50, 'PENDIENTE', 500, 1),
('2026-07-20', '2026-07-23', 50, 'PENDIENTE', 501, 2),
('2026-07-21', '2026-07-24', 50, 'PENDIENTE', 502, 3),
('2026-07-21', '2026-07-24', 50, 'PENDIENTE', 503, 4);