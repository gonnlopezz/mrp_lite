...
public class ProductoPresenter {
    ...
    public ResponseEntity<Object> create(@RequestBody Producto aProduct) {
        return Response.ok(service.save(aProduct), "Producto " + aProduct.getNombre() + " creado exitosamente");
    }

    @RequestMapping(method = RequestMethod.PUT)
    public ResponseEntity<Object> update(@RequestBody Producto aProduct) {
        return Response.ok(service.save(aProduct), "Producto " + aProduct.getNombre() + " actualizado correctamente");
    }
